            ...
            @csrf
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="complemento"  placeholder="Nome do Solicitante">
                    </div>
                    <div class="form-group">
                        <label for="quantidade"><b>Quantidade</b></label>
                        <input type="number" class="form-control" name="quantidade" placeholder="Quantidade Solicitada">
                    </div>
                    <br>
                    <div class="form-group">
