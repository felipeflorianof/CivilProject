...
<hr>
<div class='box-div'>
            <h2 class='box-search-title'>Pesquisar</h2>
            <div class='box-search'>
                <input type='search' class='form-control w-50' placeholder='Pesquise Por Material, Ferramentas e Pessoas' id='pesquisar'>   
